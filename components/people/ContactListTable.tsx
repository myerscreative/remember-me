...
export function ContactListTable({ contacts, onToggleFavorite }: ContactListTableProps) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden md:grid grid-cols-[auto_1fr_180px_150px_140px] gap-6 items-center px-6 py-4 bg-surface border-b border-border-default sticky top-0 z-20">
