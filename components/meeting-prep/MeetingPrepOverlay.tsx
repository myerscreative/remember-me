...
export function MeetingPrepOverlay({ meeting, isOpen, onClose }: MeetingPrepOverlayProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[800px] mx-auto min-h-screen md:min-h-0 md:my-8 bg-white md:rounded-3xl shadow-2xl overflow-hidden flex flex-col">
        
        {/* --- Header (Sticky) --- */}
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-4 py-4 md:px-8 md:py-6 flex justify-between items-center shadow-sm">
          <button 
            onClick={onClose}
            className="flex items-center gap-1 px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-600 font-medium transition-colors"
          >
        ...
        <div className="hidden md:block">
          ...
          <div className="px-8 py-8 bg-gradient-to-br from-blue-50 to-blue-100 border-b-2 border-indigo-500 flex gap-6 items-center">
            ...
            <div className="flex-1">
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Meeting with {contact.name}</h2>
              <div className="flex flex-wrap gap-4 text-gray-600 font-medium text-sm md:text-base mb-3">
          ...
          {/* Quick Context Bar */}
          <div className="flex flex-wrap gap-4 px-8 py-6 bg-gray-50 border-b border-gray-100">
            <div className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl text-gray-700 font-medium shadow-sm">
          ...
          <div className="px-8 py-8 border-b border-gray-100">
            ...
            <div className="grid gap-6">
              ...
              <div className="flex gap-4 p-5 bg-gray-50 rounded-2xl border border-gray-200">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Where We Met</h4>
                  <p className="text-base text-gray-900 mb-1 font-medium">{contact.whereWeMet} - {contact.whenWeMet}</p>
                  <p className="text-sm text-gray-600 italic">{contact.howWeMet}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-5 bg-gray-50 rounded-2xl border border-gray-200">
                <div className="text-2xl mt-1">💭</div>
                <div>
                  <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">What We Talked About</h4>
              ...
              <div className="flex gap-4 p-5 bg-gray-50 rounded-2xl border border-gray-200">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Why Stay in Contact</h4>
                  <p className="text-gray-900">{contact.whyStayInContact}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-5 bg-gray-50 rounded-2xl border border-gray-200">
                <div className="text-2xl mt-1">👨‍👩‍👧</div>
                <div>
                  <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">What Matters to Them</h4>
                  <ul className="list-disc pl-4 space-y-1.5 text-gray-700">
          ...
          <div className="px-8 py-8 border-b border-gray-100">
            ...
            <div className="p-5 bg-emerald-50 border-2 border-emerald-400 rounded-2xl">
              <div className="flex items-center gap-3 mb-3">
                <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-emerald-200 rounded-lg text-emerald-800 text-sm font-bold">
              ...
              <div className="p-4 bg-white rounded-xl text-emerald-900 italic border border-emerald-100">
          ...
          <div className="px-8 py-8 mx-8 my-4 bg-gradient-to-br from-amber-50 to-amber-100 border-2 border-amber-300 rounded-2xl">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="px-3 py-1 text-sm bg-white text-indigo-600 border border-indigo-300 rounded-lg hover:bg-indigo-50 disabled:opacity-50 transition-colors"
              >
          ...
          <div className="px-8 py-8 border-b border-gray-100">
             ...
             <div className="bg-linear-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-100">
                 <div className="flex flex-col md:flex-row items-center gap-6">
                     <div className="flex-1">
                         <h4 className="font-bold text-gray-900 mb-2">Want to drill before the meeting?</h4>
                         <p className="text-gray-600 text-sm mb-4">
                            Take a quick 2-minute quiz to sharpen your memory.
                         </p>
                         <div className="flex flex-wrap gap-2">
                             <Button size="sm" variant="outline" className="bg-white hover:bg-indigo-50 text-indigo-700 border-indigo-200">
                                📖 Story Recall
                             </Button>
                             <Button size="sm" variant="outline" className="bg-white hover:bg-pink-50 text-pink-700 border-pink-200">
                                🎯 Interest Check
                             </Button>
                         </div>
                     </div>
          ...
          <div className="px-8 py-8 border-b border-gray-100">
            ...
            <div className="space-y-4">
              {meeting.mutualConnections.map((conn) => (
                <div key={conn.id} className="p-5 bg-gray-50 border-2 border-gray-200 rounded-2xl hover:bg-white hover:border-indigo-500 transition-colors group">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 rounded-full bg-purple-500 text-white flex items-center justify-center font-bold">
                      {conn.initials}
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 text-lg">{conn.name}</h4>
                      <p className="text-gray-500">{conn.role}</p>
                    </div>
                  </div>
                  <div className="mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed">{conn.matchReason}</p>
                  </div>
                  <Button className="w-full bg-white text-indigo-600 border-2 border-indigo-600 hover:bg-indigo-600 hover:text-white transition-colors">
          ...
          <div className="px-8 py-8 border-b border-gray-100">
            ...
            <textarea 
              className="w-full p-4 border-2 border-gray-200 rounded-2xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all resize-none text-gray-700"
              rows={4}
          ...
          {/* Footer Actions */}
          <div className="px-8 py-8 flex gap-4 flex-wrap bg-gray-50">
             ...
             <Button variant="outline" className="flex-1 min-w-[200px] h-12 text-base font-semibold bg-white">
               Edit Contact
             </Button>
             <Button variant="outline" className="flex-1 min-w-[200px] h-12 text-base font-semibold bg-white">
               Add to Favorites ⭐
        ...
        <div className="md:hidden flex-1 overflow-x-auto snap-x snap-mandatory flex bg-gray-100 pb-8 pt-4 px-4 gap-4 no-scrollbar">
          
          {/* Card 1: Meeting Details */}
          <div className="min-w-[calc(100vw-2rem)] snap-start bg-white rounded-3xl p-6 shadow-xl flex flex-col items-center text-center overflow-y-auto max-h-[calc(100vh-180px)]">
            <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6 border-b pb-2 w-full">Meeting Details</div>
            ...
            <p className="text-gray-500 mb-6 font-medium">{contact.role}</p>

            <div className="w-full bg-gray-50 rounded-2xl p-4 mb-6 border border-gray-100">
              <div className="flex flex-col gap-2">
                <span className="font-semibold text-gray-900">Today at {new Date(meeting.startTime).toLocaleTimeString([], {hour: 'numeric', minute:'2-digit'})}</span>
            ...
            {meeting.locationUrl ? (
              ...
              <div className="w-full py-4 bg-gray-100 text-gray-500 rounded-2xl font-bold mb-4 flex items-center justify-center gap-2">
                <MapPin className="w-5 h-5" /> {meeting.location}
              </div>
            )}
            
            <div className="mt-auto pt-4 text-gray-400 text-sm font-medium animate-pulse">
              ← Swipe for context →
            </div>
          </div>

          {/* Card 2: Key Context */}
          <div className="min-w-[calc(100vw-2rem)] snap-start bg-white rounded-3xl p-6 shadow-xl flex flex-col items-center overflow-y-auto max-h-[calc(100vh-180px)]">
             <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6 border-b pb-2 w-full text-center">Key Context</div>
             
             <div className="w-full space-y-4">
               {/* Last Spoke */}
               <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 flex gap-4 items-start text-left">
                  <span className="text-2xl">💭</span>
                  <div>
                    <strong className="block text-gray-500 text-xs uppercase mb-1">Last Spoke</strong>
                    <p className="text-gray-900 font-medium">
                      {contact.lastContact.daysAgo ? `${contact.lastContact.daysAgo} days ago` : 'Never'}
                    </p>
                    <p className="text-sm text-gray-600 mt-1">"{contact.lastContact.notes}"</p>
                  </div>
               </div>
               ...
               {contact.whatMattersToThem[0] && (
                 <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 flex gap-4 items-start text-left">
                    <span className="text-2xl">👨‍👩‍👧</span>
                    <div>
                      <strong className="block text-gray-500 text-xs uppercase mb-1">What Matters</strong>
                      <p className="text-gray-900 font-medium">{contact.whatMattersToThem[0]}</p>
                    </div>
                 </div>
               )}
               ...
               {meeting.mutualConnections[0]?.sharedInterests[0] && (
                 <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 flex gap-4 items-start text-left">
                    <span className="text-2xl">🎣</span>
                    <div>
                      <strong className="block text-gray-500 text-xs uppercase mb-1">Shared Interest</strong>
                      <p className="text-gray-900 font-medium">
             ...
             <div className="mt-auto pt-8 text-gray-400 text-sm font-medium">
              ← Swipe for more →
             </div>
          </div>
          ...
          <div className="min-w-[calc(100vw-2rem)] snap-start bg-white rounded-3xl p-6 shadow-xl flex flex-col items-center overflow-y-auto max-h-[calc(100vh-180px)]">
            <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6 border-b pb-2 w-full text-center">Say This</div>
            ...
            <Button className="w-full mt-auto py-6 bg-white border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 font-bold rounded-2xl shadow-none">
              View Full Details →
            </Button>
          </div>
