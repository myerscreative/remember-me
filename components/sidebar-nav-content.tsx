...
import { Users, Bell, Activity, Settings, Sparkles, Calendar, Brain, Flame, TreePine, ShieldAlert, Sprout, BookOpen } from "lucide-react";
  ...
  [
    {
      ...
      label: "Dashboard",
      icon: Activity,
      inactiveColor: "text-text-tertiary",
    },
    {
      href: "/",
      label: "People",
