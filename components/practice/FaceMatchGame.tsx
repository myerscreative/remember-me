  ...
  if (contacts.length < 4) {
    return (
        <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center">
            <p className="text-xl text-text-tertiary mb-4">Not enough contacts with photos to play.</p>
  ...
  return (
    ...
    >
      ...
      <div className="bg-surface rounded-3xl shadow-xl overflow-hidden border border-border-default">
        ...
        {/* Photo Section */}
        <div className="h-64 bg-subtle relative flex items-center justify-center overflow-hidden">
        ...
        <div className="p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {roundState.options.map((option) => {
                    ...
                    let buttonStyle = "bg-surface border-2 border-border-default hover:border-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 text-text-primary";

                    if (roundState.selectedOption) {
                        if (isTarget) {
                            buttonStyle = "bg-green-100 dark:bg-green-900/40 border-2 border-green-500 text-green-800 dark:text-green-300";
                        } else if (isSelected && !isTarget) {
                            buttonStyle = "bg-red-50 dark:bg-red-900/40 border-2 border-red-200 text-red-800 dark:text-red-300";
                        } else {
                            buttonStyle = "bg-canvas border-border-default text-text-secondary opacity-50";
                        }
                    }
        ...
        {roundState.selectedOption && (
            <div className="p-4 bg-canvas border-t border-border-default flex justify-center animate-in slide-in-from-bottom-4 fade-in">
                <Button 
