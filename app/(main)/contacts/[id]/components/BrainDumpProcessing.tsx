...
export const BrainDumpProcessing = ({ name }: BrainDumpProcessingProps) => {
  return (
    <div className="p-8 bg-canvas/80 backdrop-blur-xl rounded-3xl border border-indigo-500/50 text-center shadow-2xl shadow-indigo-500/10 overflow-hidden relative">
      ...
      <h3 className="text-text-primary font-black text-2xl mb-3 tracking-tight">Analyzing Your Connection...</h3>
      <p className="text-text-tertiary text-sm leading-relaxed max-w-[280px] mx-auto">
      ...
      <div className="mt-8 flex justify-center items-center gap-8 relative h-12">
        <div className="flex flex-col items-center gap-1 opacity-50">
          ...
          <span className="text-[10px] uppercase font-bold text-text-tertiary">Story</span>
        </div>
        <div className="flex flex-col items-center gap-1 opacity-50">
          <div className="w-2 h-2 rounded-full bg-elevated" />
          <span className="text-[10px] uppercase font-bold text-text-tertiary">Family</span>
        </div>
        <div className="flex flex-col items-center gap-1 opacity-50">
          <div className="w-2 h-2 rounded-full bg-elevated" />
          <span className="text-[10px] uppercase font-bold text-text-tertiary">Health</span>
        </div>
