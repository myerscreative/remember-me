  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {!session ? (
          /* Not Signed In State */
          <div className="bg-surface rounded-2xl p-12 shadow-sm border border-border-default text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  ...
                  <h3 className="font-semibold text-text-primary mb-1">The Story</h3>
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  <div className="text-2xl mb-2">💬</div>
                  <h3 className="font-semibold text-text-primary mb-1">Conversation Starters</h3>
                  <p className="text-sm text-text-secondary">
                ...
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <div className="text-2xl mb-2">🤝</div>
                  <h3 className="font-semibold text-text-primary mb-1">Mutual Connections</h3>
                  <p className="text-sm text-text-secondary">
