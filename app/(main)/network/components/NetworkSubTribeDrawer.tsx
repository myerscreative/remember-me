  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
           <div className="bg-surface/50 backdrop-blur-md border-y border-border-default/50 py-6">
              <div className="max-w-4xl mx-auto px-4">
                  {subTribes.length === 0 ? (
                      <p className="text-center text-text-tertiary italic">No tags found in this domain yet.</p>
                  ) : (
                              ...
                              <button
                                  ...
                                  className={cn(
                                      ...
                                      selectedSubTribeId === st.id
                                          ? "bg-surface shadow-sm scale-105"
                                          : "bg-transparent border-transparent hover:bg-surface/40 text-text-secondary"
                                  )}
                                  style={{
