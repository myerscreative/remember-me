...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-canvas to-surface">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-surface/80 backdrop-blur-md border-b border-border-default">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              <Heart className="w-6 h-6 text-blue-600" />
              <span className="text-xl font-bold text-text-primary">ReMember Me</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="px-8 py-4 bg-surface text-text-primary rounded-xl hover:bg-canvas transition-colors border-2 border-border-default text-lg font-semibold cursor-pointer">
                Watch Demo
              </button>
            </div>
      ...
      {/* Problem Statement */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-canvas text-white">
        <div className="max-w-7xl mx-auto">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group p-8 bg-surface rounded-2xl border-2 border-border-default hover:border-blue-600 transition-all cursor-pointer hover:shadow-xl">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-600 transition-colors">
                <Brain className="w-6 h-6 text-blue-600 group-hover:text-white transition-colors" />
              </div>
              <h3 className="text-xl font-bold text-text-primary mb-3">AI-Powered Context</h3>
            ...
            <div className="group p-8 bg-surface rounded-2xl border-2 border-border-default hover:border-blue-600 transition-all cursor-pointer hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Meeting Prep Mode</h3>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="group p-8 bg-surface rounded-2xl border-2 border-border-default hover:border-blue-600 transition-all cursor-pointer hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Instant Import</h3>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="group p-8 bg-surface rounded-2xl border-2 border-border-default hover:border-blue-600 transition-all cursor-pointer hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Voice Memos</h3>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="group p-8 bg-surface rounded-2xl border-2 border-border-default hover:border-blue-600 transition-all cursor-pointer hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Smart Summaries</h3>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="group p-8 bg-surface rounded-2xl border-2 border-border-default hover:border-blue-600 transition-all cursor-pointer hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Relationship Garden</h3>
              <p className="text-text-secondary leading-relaxed">
      ...
      {/* Social Proof */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-canvas">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-surface p-8 rounded-2xl border border-border-default shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-text-primary">Sarah Mitchell</p>
                  <p className="text-sm text-text-secondary">Sales Director</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface p-8 rounded-2xl border border-border-default shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-text-primary">James Chen</p>
            ...
            <div className="bg-surface p-8 rounded-2xl border border-border-default shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-text-primary">Emily Parker</p>
      ...
      {/* Footer */}
      <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-canvas text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-8 border-t border-border-default text-center text-sm text-text-tertiary">
